...
public final class Messages
{
    ...
    public enum Fixed
    {
        ...
        TUTORIAL3(
                "&fThe skillinfo shows that your low level demotionist skill allows you to craft" + " a normal amount of TNT. If you increase this skill enough, you'll get 2 or " + "even more TNT per craft. The skill also affects damage you take from explosions. "
                        + "Below that, it shows how to train the skill. Find a nearby trainer and left click " + "them to get more information about the skill. Right click to attempt training" + ", then continue with &4/tutorial 4&f" ),
        TUTORIAL4(
                "&fWhen you tried to train the skill, it showed what training cost was missing. All " + "skills train for a cost in relevant materials. The first few levels cost little," + "but becoming a master is very challenging. Continue with &4/tutorial 5&f" ),
        TUTORIAL5(
                "&fMost trainers can only take you to a limited level, you'll need to seek out the " + "best trainers in the world to eventually reach level " + plugin.getConfigManager().getMaxSkillLevel() + " in a skill. Go gather"
                        + "some dirt, stone, or logs and try to train up a relevant skill, using what" + "you have learned, then continue with &4/tutorial 6&f" ),
